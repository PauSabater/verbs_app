        ...
        <Fragment>
            <div className={`${styles.alert} ${isOpen ? styles.open : styles.closed}`}>
                ...
                <div className={styles.container}>
                    ...
                    {  props.texts.textCheckbox
                        ? <InputCheckbox
                            label={props.texts.textCheckbox }
                            actionsOnInputChange={handleCheckboxChange}
                        />
                        : ''
                    }
                    <div className={styles.buttonsContainer}>
                        <div onClick={()=> handleClickConfirm()}>
                            <Button
                                text={props.texts.textConfirm}
                            />
                        </div>
                        <div onClick={()=> handleClickNegate()}>
                            <Button
                                text={props.texts.textNegate}
                                color={"primaryDarkReverse"}
                            />
                        </div>
                    </div>
                </div>
